...
// src/testsAutoImporter/writeFile/writeFile.test.js
...
var writeFile_test = () => {
  describe("write file", () => {
    it("write data to a file", async () => {
      const filePath = "./src/testsAutoImporter/writeFile/tests/writeFile/writeFileTest.json";
      const content = "test";
      const expected = "test";
...
// src/testsAutoImporter/scanDirectoryTree/scanDirectoryTree.test.js
var scanDirectoryTree_test_exports = {};
__export(scanDirectoryTree_test_exports, {
  scanDirectoryTree_test: () => scanDirectoryTree_test
});
...
var PathWin32 = class _PathWin32 extends PathBase {
  ...
  newChild(name, type3 = UNKNOWN, opts = {}) {
    return new _PathWin32(name, type3, this.root, this.roots, this.nocase, this.childrenCache(), opts);
  }
  /**
   * @internal
   */
...
var PathPosix = class _PathPosix extends PathBase {
   ...
   */
  newChild(name, type3 = UNKNOWN, opts = {}) {
    return new _PathPosix(name, type3, this.root, this.roots, this.nocase, this.childrenCache(), opts);
  }
};
...
// src/testsAutoImporter/scanDirectoryTree/scanDirectoryTree.js
async function scanDirectoryTree({ pattern, options = {} }) {
  return await glob(pattern, options);
}

// src/testsAutoImporter/scanDirectoryTree/scanDirectoryTree.test.js
var scanDirectoryTree_test = () => {
  describe("scan directory scan directory and return all files and one level of subdirectories", () => {
    it("scan directory and return single file in folder", async () => {
      const expected = [
        "src\\testsAutoImporter\\scanDirectoryTree\\tests\\singleFile\\singleFile.tst.js"
      ];
      const result = await scanDirectoryTree({
        pattern: "src/testsAutoImporter/scanDirectoryTree/tests/singleFile/singleFile.tst.js"
    ...
    it("scan directory and return 3 files from 3 levels of subfolders", async () => {
      const expected = [
        "src\\testsAutoImporter\\scanDirectoryTree\\tests\\directoryTree\\fileAtLevel0.tst.js",
        "src\\testsAutoImporter\\scanDirectoryTree\\tests\\directoryTree\\level0\\level1\\fileAtLevel1.tst.js",
        "src\\testsAutoImporter\\scanDirectoryTree\\tests\\directoryTree\\level0\\level1\\level2\\fileAtLevel2.tst.js",
        "src\\testsAutoImporter\\scanDirectoryTree\\tests\\directoryTree\\level0\\level1\\level2\\level3\\fileAtLevel3.tst.js"
      ];
      const result = await scanDirectoryTree({
        pattern: "src/testsAutoImporter/scanDirectoryTree/tests/directoryTree/**/*.tst.js"
        // options: { ignore: "node_modules/**" },
      });
      expect(result).toBe(expected);
    });
...
__export(createImportsFromPaths_test_exports, {
  createImportsFromPaths_test: () => createImportsFromPaths_test
});

// src/testsAutoImporter/utils/arrays/strings/createImportsFromPaths/createImportsFromPaths.js
function createImportsFromPaths({ filePaths, importName }) {
  const imports = filePaths.map((path2) => `'${path2}'`).map((path2, index) => `import * as ${importName}${index} from ${path2}`).map((path2) => path2.concat("\n"));
  return imports;
}

// src/testsAutoImporter/utils/arrays/strings/createImportsFromPaths/createImportsFromPaths.test.js
var createImportsFromPaths_test = () => {
...
// src/testsAutoImporter/utils/arrays/strings/createImportsExportsFromPaths/createImportsExportsFromPaths.test.js
var createImportsExportsFromPaths_test_exports = {};
__export(createImportsExportsFromPaths_test_exports, {
  createImportsExportsFromPaths_test: () => createImportsExportsFromPaths_test
});

// src/testsAutoImporter/utils/arrays/strings/createExportsFromArray/createExportsFromArray.js
function createExportsFromArray({
  exportName,
  importNames,
  joinSymbols
}) {
  const importNamesDestructuredString = importNames.map((importName) => `...${importName}`).join(joinSymbols);
  const withAddedBrackets = `{${importNamesDestructuredString}}`;
  const withExport = `export const ${exportName} = ${withAddedBrackets}`;
  return withExport;
}

// src/testsAutoImporter/utils/arrays/strings/createImportNamesFromArrayIndexes/createImportNamesFromArrayIndexes.js
function createImportNamesFromArrayIndexes({ array, name }) {
  return array.map((_, index) => `${name}${index}`);
}

// src/testsAutoImporter/utils/arrays/strings/createImportsExportsFromPaths/createImportsExportsFromPaths.js
function createImportsExportsFromPaths({
  filePaths,
  importName,
  exportName,
  exportJoinSymbols
...
// src/testsAutoImporter/utils/arrays/strings/createImportsExportsFromPaths/createImportsExportsFromPaths.test.js
var createImportsExportsFromPaths_test = () => {
...
// src/testsAutoImporter/utils/arrays/strings/createImportNamesFromArrayIndexes/createImportNamesFromArrayIndexes.test.js
var createImportNamesFromArrayIndexes_test_exports = {};
__export(createImportNamesFromArrayIndexes_test_exports, {
  createImportNamesFromArrayIndexes_test: () => createImportNamesFromArrayIndexes_test
});
var createImportNamesFromArrayIndexes_test = () => {
...
// src/testsAutoImporter/utils/arrays/strings/createExportsFromArray/createExportsFromArray.test.js
var createExportsFromArray_test_exports = {};
__export(createExportsFromArray_test_exports, {
  createExportsFromArray_test: () => createExportsFromArray_test
});
var createExportsFromArray_test = () => {
